...
#==============================================================================
        ...
        zakładki = ttk.Notebook(self)
        zakładki.grid(row = 10, column = 1, columnspan = 11)

        taba = ttk.Frame(zakładki)#,relief = GROOVE)
        tabm = ttk.Frame(zakładki)#,relief = GROOVE)

        zakładki.add(taba, text='\n                      TABLICZKA DODAWANIA                    \n')
        zakładki.add(tabm, text='\n                      TABLICZKA MNOŻENIA                     \n')
        ...
        Radiobutton(taba, text = "Tabliczka dodawania  -  kontynuacja",font=('Calibri', 11),
                    indicatoron = 0,width = 33, pady = 3, variable = self.table, value = "a",
                    command = self.addition_table).grid(row =1, column = 1,columnspan = 4)#, sticky = W)
#                    command = self.addition_table_new

#==============================================================================
        # utwórzenie zmiennej, która ma reprezentować wybór tabliczki dodawania - nowa czy kontynuacja
        self.table_a = StringVar()
        self.table_a.set(None)
        # utwórzenie przycisku opcji do wyboru tabliczki dodawania nowa
        Radiobutton(taba, text = "Nowa tabliczka",font=('Calibri', 10), indicatoron = 0,
                    width = 28, variable = self.table_a, value = "n",
                    command = self.addition_table_new).grid(row = 3, column = 1,columnspan = 4)#, sticky = W)
...
#==============================================================================
        ...
        # utwórzenie przycisku opcji do wyboru tabliczki dodawania nowa
        Radiobutton(taba, text = "Zakres  :  1 ÷ 10", font=('Calibri', 10), indicatoron = 0,
                    width = 17, pady = 3,variable = self.range_a,value = "p",
                    command = self.addition_table_new_range).grid(row = 5, column = 1,columnspan = 2, sticky = W)

        # utwórzenie przycisku opcji do wyboru tabliczki dodawania kontynuacja
        Radiobutton(taba, text = "Zakres  :  1 ÷ 100",font=('Calibri', 10), indicatoron = 0,
                    width = 17, pady = 3, variable = self.range_a, value = "r",
                    command = self.addition_table_new_range).grid(row = 5, column = 3, columnspan = 2, sticky = E)


#etykiety - puste linie oddzielająace od siebie przyciski w zakładkach

        #etykieta z pustą linią lewy margines A
        self.linia = Label(taba, text = "              ",font = ('Courier New', 11)).grid(row = 1, column = 0,sticky = N)#,relief = SUNKEN
        #etykieta z pustą linią A
        self.linia = Label(taba, text = "              ", font = ('Courier New', 2)).grid(row = 2, column = 1)
        #etykieta z pustą linią A
        self.linia = Label(taba, text = "              ", font = ('Courier New', 2)).grid(row = 4, column = 1)

        #etykieta z pustą linią lewy margines M
        self.linia = Label(tabm,text = "              ", font = ('Courier New', 11)).grid(row = 1, column = 0,sticky = N)
        #etykieta z pustą linią M
        self.linia = Label(tabm,text = "              ", font = ('Courier New', 2)).grid(row =2, column = 1)
        #etykieta z pustą linią M
        self.linia = Label(tabm, text = "              ", font = ('Courier New', 2)).grid(row = 4, column = 1)




        Radiobutton(tabm,text = "Tabliczka mnożenia   -   kontynuacja",font=('Calibri', 11),
                    indicatoron = 0, width = 33, pady = 3, variable = self.table,
                    value = "m", command = self.multiplication_table).grid(row = 1, column = 1, columnspan = 4)#, sticky = E)
#==============================================================================

        self.table_m = StringVar()
        self.table_m.set(None)
        # utwórzenie przycisku opcji do wyboru tabliczki mnożenia
        Radiobutton(tabm, text = "Nowa tabliczka", font=('Calibri', 10),indicatoron = 0,
                    width = 28,variable = self.table_m, value = "n",
                    command = self.multiplication_table_new).grid(row = 3, column = 1,columnspan = 4)#, sticky = E)



        """Wybór - zakres zmiennych: 1 ÷ 10 lub 1 ÷ 100."""
        # utwórzenie zmiennej, która ma reprezentować wybór zakresu tabliczki dodawania
        self.range_m = StringVar()
        self.range_m.set(None)#'p')
        # utwórzenie przycisku opcji do wyboru tabliczki dodawania nowa
        Radiobutton(tabm, text = "Zakres  :  1 ÷ 10",font=('Calibri', 10), indicatoron = 0,
                    variable = self.range_m, width = 17, pady = 3,value = "p",
                    command = self.multiplication_table_new_range).grid(row = 5, column = 1,columnspan = 2, sticky = W)

        # utwórzenie przycisku opcji do wyboru tabliczki dodawania kontynuacja
        Radiobutton(tabm, text = "Zakres  :  1 ÷ 100", font=('Calibri', 10),indicatoron = 0,
                    width = 17, pady = 3, variable = self.range_m, value = "r",
                    command = self.multiplication_table_new_range).grid(row = 5, column = 3, columnspan = 2, sticky = E)
#==============================================================================
        #etykieta z pustą linią nad oknem tytułu tabliczki
#        self.linia = Label(tabm, font = ('Courier New', 5),text = " ").grid(row = 3, column = 1)
...
#==============================================================================
        #etykieta z pustą linią nad oknem tytułu tabliczki
        self.linia = Label(self, font = ('Courier New', 5),text = " ").grid(row = 25, column = 1)
#==============================================================================
...
#==============================================================================
    def addition_table(self):
        ...
        global zakres_b
        global board
#        print('board_a - choice_a0: ',board_a)
...
#        board_a = self.new_board(zakres_a,zakres_b)         #utworzenie nowej tablicy dodawania
...
#        print('board_a - choice_a1: ',board_a)
#        print('board - choice_a1: ',board)
#        print('board_a - choice_a1: ',board_a)


#        board = self.new_board(zakres_a, zakres_b)        #utworzenie nowej tablicy mnożenia
#        self.display_board(0,0,board_a)   #wyświetlenie tablicy mnożenia
...
#                                command = self.answer_a_get
 #==============================================================================
    ...
    def addition_table_new_range(self):
        """Wybór - tabliczka mnożenia nowa - w zależności od wybranego zakresu."""
        global board_a
        global zakres
...
#====================================================
    def main_addition(self,board_a):  #generowanie pytania
        global x_a
        global y_a
        global x_az
        global y_az
...
#====================================================
        ...
        for i in range(1,11):
            ...
            board_a[i][0] = y_az0
#=========================================
        #ustalenie wartości zmiennych w zależności od zakresów
        lista_az = []
        for k in range(0,10):
            x_az = x_a + (k * 10)
...
#=================================
        ...
        return x_a,y_a,board_a#x_az,y_az,
...
#==============================================================================
    def answer_addition(self,answer,board_a):
        if answer == x_az + y_az:     #answer__a:
...
#==============================================================================
    def multiplication_table(self):
        ...
        global zakres_b
        global board
#        board_m = self.new_board_d(zakres_a,zakres_b)       #utworzenie nowej tablicy mnożenia

        self.range_m.set(None)#'p')
        self.range_a.set(None)#'p')
        self.table_a.set(None)
#        self.table_b.set(None)
...
#====================================================
    ...
    def answer_multiplication_get(self):#,Button):
        """Pobranie odpowiedzi"""
...
#==============================================================================
    def answer_multiplication(self,answer,board_m):
        if answer == x_mz * y_mz: 
            self.answer_txt.delete(0.0, END)
